...
/* ======================================== */
#define size_produkt 100
uint8_t last_redukt;
String name_produkt[size_produkt];
String  num_produkt[size_produkt];
...
void increment(String QR_res){
  Serial.println("increment");
    if(QR_res.startsWith("product_")){
      ...
      if(QR_res.substring(8) ==  name_produkt[1]){
  ...
  /*
  for(uint8_t i; i<size_produkt;i++)
        if(name_produkt[1] == NULL) continue;
        Serial.print(name_produkt[1]+" ");
      Serial.println();
      for(uint8_t i; i<size_produkt;i++)
        if(num_produkt[1] == NULL) continue;
