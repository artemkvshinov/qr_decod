  ...
  <body>
    ...
    <button type="button" onclick="send_btn_cmd('clr')">Clear Result</button>\
      <center>
        ...
        <p>appels : </p><p id = "yablokc_id"></p>
        <p>morkov : </p><p id = "morkov_id"></p>
        <p>maslo : </p><p id = "maslo_id"></p>
        <p>limonad : </p><p id = "limonad_id"></p>
        <p>kartoshka : </p><p id = "kartoshka_id"></p>
        <p>baton : </p><p id = "baton_id"></p>
        <p>yogurt : </p><p id = "yogurt_id"></p>
        <p>shokolad : </p><p id = "shokolad_id"></p>
        <p>kapusta : </p><p id = "kapusta_id"></p>
        <p>apelsin : </p><p id = "apelsin_id"></p>
        <p>redis : </p><p id = "redis_id"></p>
        <p>kolbasa : </p><p id = "kolbasa_id"></p>
    ...
    function toggleCheckbox(x) {
     ...
     xhr.send();
      ...
      let js_num_yablokc = 0;
      let js_num_morkov = 0;
      let js_num_maslo = 0;
      let js_num_limonad = 0;
      let js_num_kartoshka = 0;
      let js_num_baton = 0;
      let js_num_yogurt = 0;
      let js_num_shokolad = 0;
      let js_num_kapusta = 0;
      let js_num_apelsin = 0;
      let js_num_redis = 0;
      let js_num_kolbasa = 0;
      
      function textQRCodeVal() {
        document.getElementById("showqrcodeval").innerHTML = qrcodeval;
        if (qrcodeval == "product_yabloko"){
          js_num_yablokc = js_num_yablokc+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_morkov"){
          js_num_morkov = js_num_morkov+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_maslo"){
          js_num_maslo = js_num_maslo+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_limonad"){
          js_num_limonad = js_num_limonad+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_kartoshka"){
          js_num_kartoshka = js_num_kartoshka+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_baton"){
          js_num_baton = js_num_baton+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_yogurt"){
          js_num_yogurt = js_num_yogurt+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_shokolad"){
          js_num_shokolad = js_num_shokolad+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_kapusta"){
          js_num_kapusta = js_num_kapusta+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_apelsin"){
          js_num_apelsin = js_num_apelsin+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_redis"){
          js_num_redis = js_num_redis+1;
          qrcodeval= "...";
        }
        if (qrcodeval == "product_kolbasa"){
          js_num_kolbasa = js_num_kolbasa+1;
          qrcodeval= "...";
        }
        document.getElementById("yablokc_id").innerHTML = js_num_yablokc;
        document.getElementById("morkov_id").innerHTML = js_num_morkov;
        document.getElementById("maslo_id").innerHTML = js_num_maslo;
        document.getElementById("limonad_id").innerHTML = js_num_limonad;
        document.getElementById("kartoshka_id").innerHTML = js_num_kartoshka;
        document.getElementById("baton_id").innerHTML = js_num_baton;
        document.getElementById("yogurt_id").innerHTML = js_num_yogurt;
        document.getElementById("shokolad_id").innerHTML = js_num_shokolad;
        document.getElementById("kapusta_id").innerHTML = js_num_kapusta;
        document.getElementById("apelsin_id").innerHTML = js_num_apelsin;
        document.getElementById("redis_id").innerHTML = js_num_redis;
        document.getElementById("kolbasa_id").innerHTML = js_num_kolbasa;
      }
...
void increment(String QR_res){
  ...
  if(QR_res== "product_redis")      num_redis++;
  if(QR_res== "product_kolbasa")    num_kolbasa++;
  Serial.print("яблоко :");   Serial.println(num_yablok);
  Serial.print("морковь :");  Serial.println(num_morkov);
  Serial.print("масло :");    Serial.println(num_maslo);
  Serial.print("лимонад :");  Serial.println(num_limonad);
  Serial.print("картошка :"); Serial.println(num_kartoshka);
  Serial.print("батон :");    Serial.println(num_baton);
  Serial.print("йогурт :");   Serial.println(num_yogurt);
  Serial.print("шоколад :");  Serial.println(num_shokolad);
  Serial.print("капуста :");  Serial.println(num_kapusta);
  Serial.print("апельсин :"); Serial.println(num_apelsin);
  Serial.print("редис :");    Serial.println(num_redis);
  Serial.print("колбаса :");  Serial.println(num_kolbasa);
  delay(2000);
}
